...
static control_script_extension generate_modifications(const int &id)
{
  ...
  */
  ...
  ext.add_method("sg_release",  register_arg(INPUT_INTEGER_REG_1, REGISTER_TYPE_INT),
                                register_arg(INPUT_INTEGER_REG_2, REGISTER_TYPE_INT),
                                register_arg(INPUT_INTEGER_REG_3, REGISTER_TYPE_BOOL),
