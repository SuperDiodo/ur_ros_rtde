...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "set_digital_pin_command"
#define PLUGIN_CLASS_NAME SetDigitalPin
using action_type = ur_ros_rtde_msgs::action::SetDigitalPin;
// -----------------------------------------
...
{ 
  ...
  result->result = rtde_io->setStandardDigitalOut(goal->pin, goal->state);
