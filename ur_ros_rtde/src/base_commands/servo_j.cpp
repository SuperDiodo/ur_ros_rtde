...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "servo_j_command"
#define PLUGIN_CLASS_NAME ServoJ
using action_type = ur_ros_rtde_msgs::action::ServoJ;
// -----------------------------------------
...
{ 
  ...
  result->result = rtde_control->servoJ(goal->joint_positions, 0.0, 0.0, goal->time, goal->lookahead_time, goal->gain);
