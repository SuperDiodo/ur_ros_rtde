...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "reset_force_torque_sensor_command"
#define PLUGIN_CLASS_NAME ResetForceTorqueSensor
using action_type = ur_ros_rtde_msgs::action::ResetForceTorqueSensor;
// -----------------------------------------
