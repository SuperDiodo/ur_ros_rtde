...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "servo_stop_command"
#define PLUGIN_CLASS_NAME ServoStop
using action_type = ur_ros_rtde_msgs::action::ServoStop;
// -----------------------------------------
...
{ 
  ...
  rtde_control->servoStop(goal->acceleration);
  result->result = true;
