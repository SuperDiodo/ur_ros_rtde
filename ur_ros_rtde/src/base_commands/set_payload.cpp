...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "set_payload_command"
#define PLUGIN_CLASS_NAME SetPayload
using action_type = ur_ros_rtde_msgs::action::SetPayload;
// -----------------------------------------
    ...
    std::shared_ptr<ur_rtde::DashboardClient> dashboard_client)
{
    ...
    result->result = rtde_control->setPayload(
