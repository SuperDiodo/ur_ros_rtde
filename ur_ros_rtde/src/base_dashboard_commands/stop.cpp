...
#include <ur_ros_rtde_msgs/action/stop.hpp>
#include <pluginlib/class_list_macros.hpp>

// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "stop_dashboard_command"
#define PLUGIN_CLASS_NAME Stop
using action_type = ur_ros_rtde_msgs::action::Stop;
// -----------------------------------------
...
{
  // ---------- PLUGIN BEHAVIOUR ----------
  auto result = std::make_shared<ur_ros_rtde_msgs::action::Stop::Result>();
  bool succeded = true;
