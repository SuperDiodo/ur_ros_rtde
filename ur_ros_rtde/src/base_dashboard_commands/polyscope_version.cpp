...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "polyscope_version_dashboard_command"
#define PLUGIN_CLASS_NAME PolyscopeVersion
using action_type = ur_ros_rtde_msgs::action::PolyscopeVersion;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->polyscopeVersion();
  }
  catch (...)
  {
    succeded = false;
