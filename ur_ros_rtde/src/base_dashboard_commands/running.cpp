...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "running_dashboard_command"
#define PLUGIN_CLASS_NAME Running
using action_type = ur_ros_rtde_msgs::action::Running;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->running();
  }
  catch (...)
  {
    succeded = false;
