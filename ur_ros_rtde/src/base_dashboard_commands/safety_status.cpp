...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "safety_status_dashboard_command"
#define PLUGIN_CLASS_NAME SafetyStatus
using action_type = ur_ros_rtde_msgs::action::SafetyStatus;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->safetystatus();
  }
  catch (...)
  {
    succeded = false;
