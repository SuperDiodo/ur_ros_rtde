...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "popup_dashboard_command"
#define PLUGIN_CLASS_NAME Popup
using action_type = ur_ros_rtde_msgs::action::Popup;
// -----------------------------------------
...
{ 
  ...
  try
  {
    dashboard_client->popup(goal->request);
  }
  catch (...)
  {
    succeded = false;
