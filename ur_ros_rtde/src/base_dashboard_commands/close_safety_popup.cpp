...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "close_safety_popup_dashboard_command"
#define PLUGIN_CLASS_NAME CloseSafetyPopup
using action_type = ur_ros_rtde_msgs::action::CloseSafetyPopup;
// -----------------------------------------
