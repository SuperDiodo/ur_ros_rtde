...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "is_program_saved_dashboard_command"
#define PLUGIN_CLASS_NAME IsProgramSaved
using action_type = ur_ros_rtde_msgs::action::IsProgramSaved;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->isProgramSaved();
  }
  catch (...)
  {
    succeded = false;
