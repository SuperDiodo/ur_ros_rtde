...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "unlock_protective_stop_dashboard_command"
#define PLUGIN_CLASS_NAME UnlockProtectiveStop
using action_type = ur_ros_rtde_msgs::action::UnlockProtectiveStop;
// -----------------------------------------
