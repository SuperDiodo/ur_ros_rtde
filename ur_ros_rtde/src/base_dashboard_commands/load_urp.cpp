...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "load_urp_dashboard_command"
#define PLUGIN_CLASS_NAME LoadUrp
using action_type = ur_ros_rtde_msgs::action::LoadUrp;
// -----------------------------------------
...
{ 
  ...
  try
  {
    dashboard_client->loadURP(goal->request);
  }
  catch (...)
  {
    succeded = false;
