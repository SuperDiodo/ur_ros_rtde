...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "program_state_dashboard_command"
#define PLUGIN_CLASS_NAME ProgramState
using action_type = ur_ros_rtde_msgs::action::ProgramState;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->programState();
  }
  catch (...)
  {
    succeded = false;
