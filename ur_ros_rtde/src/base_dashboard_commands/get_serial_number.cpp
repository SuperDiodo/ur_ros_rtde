...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "get_serial_number_dashboard_command"
#define PLUGIN_CLASS_NAME GetSerialNumber
using action_type = ur_ros_rtde_msgs::action::GetSerialNumber;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->getSerialNumber();
  }
  catch (...)
  {
    succeded = false;
