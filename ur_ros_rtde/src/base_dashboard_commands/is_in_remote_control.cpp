...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "is_in_remote_control_dashboard_command"
#define PLUGIN_CLASS_NAME IsInRemoteControl
using action_type = ur_ros_rtde_msgs::action::IsInRemoteControl;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->isInRemoteControl();
  }
  catch (...)
  {
    succeded = false;
