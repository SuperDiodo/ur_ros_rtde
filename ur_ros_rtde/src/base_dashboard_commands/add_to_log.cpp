...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "add_to_log_dashboard_command"
#define PLUGIN_CLASS_NAME AddToLog
using action_type = ur_ros_rtde_msgs::action::AddToLog;
// -----------------------------------------
...
{ 
  ...
  try
  {
    dashboard_client->addToLog(goal->request);
  }
  catch (...)
  {
    succeded = false;
