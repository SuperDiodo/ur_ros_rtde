...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "safety_mode_dashboard_command"
#define PLUGIN_CLASS_NAME SafetyMode
using action_type = ur_ros_rtde_msgs::action::SafetyMode;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->safetymode();
  }
  catch (...)
  {
    succeded = false;
