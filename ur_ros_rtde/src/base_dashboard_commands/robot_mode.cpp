...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "robot_mode_dashboard_command"
#define PLUGIN_CLASS_NAME RobotMode
using action_type = ur_ros_rtde_msgs::action::RobotMode;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->robotmode();
  }
  catch (...)
  {
    succeded = false;
