...
// ---------- PLUGIN INFO ------------------
#define PLUGIN_NAME "get_robot_model_dashboard_command"
#define PLUGIN_CLASS_NAME GetRobotModel
using action_type = ur_ros_rtde_msgs::action::GetRobotModel;
// -----------------------------------------
...
{ 
  ...
  try
  {
    result->result = dashboard_client->getRobotModel();
  }
  catch (...)
  {
    succeded = false;
